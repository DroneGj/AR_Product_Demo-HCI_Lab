package com.example.arproductdemo_hci;
...
public class MainActivity extends AppCompatActivity {
    ...
    private float distance_z=0f;
    private float myangle=0f;


    int[] sfb_source = {R.raw.chair, R.raw.plant, R.raw.center_table, R.raw.sofa, R.raw.cart, R.raw.crate, R.raw.shelby};
    String[] arr_models = {"Chair", "Plant", "Center Table", "Sofa", "Shopping cart", "Wooden Crate", "Shelby Cobra"};
